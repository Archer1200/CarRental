...
const Testimonial = () => {
    const testimonials = [
        ...
        { name: "Emma Rodriguez", 
          ...
          review: "I highly recommended CarRental! Their fllet is amazing and I alsways feel like I'm fetting the best deal with excellent service." 
        },
    ...
    return (
        ...
        <div className=" py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            <Title title="What our Customer says" subTitle=" Dicover why discerning travellers choose StayVenture for their luxury accommodations around the world."/>
